                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{route('designation.store')}} " class="form-horizontal"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h3 class="m-t-none m-b navbar-static-top"> Designation Information </h3>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">  Name</label>
                                                        ...
                                                        <div class="col-sm-8"><input type="text"
                                                                                     ...
                                                                                     class="form-control"
                                                                                     value="{{ old('pr_name') ?? $designation->designation_name }}"
                                                                                     required>
                                                            <div class="alert-danger" >{{$errors->first('designation_name')}} </div>
                                                        </div>
                                                    </div>
