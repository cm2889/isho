                    ...
                    <div class="ibox-content">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                {{--{{route('parent_question.update',['parent_question'=>$parent_question])}}--}}
                                <form method="POST" action="{{route('admin_type.update',['admin_type'=>$admin_type])}} " class="form-horizontal"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h3 class="m-t-none m-b navbar-static-top"> Edit Admin Type Information </h3>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">  Name</label>
                                                        ...
                                                        <div class="col-sm-8"><input type="text"
                                                                                     ...
                                                                                     name="name"
                                                                                     class="form-control"
                                                                                     value="{{ old('name') ?? $admin_type->name }}"
